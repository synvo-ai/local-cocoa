...
function mapEmailMessageSummary(payload: any): EmailMessageSummary {
    return {
        ...
        to: Array.isArray(payload.to_recipients) ? payload.to_recipients.map(String) : [],
        cc: Array.isArray(payload.cc_recipients) ? payload.cc_recipients.map(String) : [],
        bcc: Array.isArray(payload.bcc_recipients) ? payload.bcc_recipients.map(String) : [],
